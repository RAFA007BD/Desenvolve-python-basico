...
#Entradas
produto=input("Digite o nome do produto 1: ")
preco1=float(input("Digite o preço unitário do produto 1: "))
qtde1=int(input("Digite a quantidade do produto 1: "))

produto=input("Digite o nome do produto 2:")
preco2=float(input("Digite o preço unitário do produto 2: "))
qtde2=int(input("Digite a quantidade do produto 2:"))

produto=input("Digite o nome do produto 3: ")
preco3=float(input("Digite o preço unitário do produto 3: "))
qtde3=int(input("Digite a quantidade do produto 3: "))

#Fórmula
total=((preco1*qtde1)+(preco2*qtde2)+(preco3*qtde3))

#Descrição dos itens
print(f"Produto 1: {produto}")
print(f"Preço: R${preco1}")
print(f"Quantidade: {qtde1}")

print(f"Produto 2: {produto}")
print(f"Preço: R${preco2}")
print(f"Quantidade: {qtde2}")

print(f"Produto 3: {produto}")
print(f"Preço: R${preco3}")
print(f"Quantidade: {qtde3}")
